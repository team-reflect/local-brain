// Build a signed, notarized, distribution-ready macOS bundle of Local Brain.
//
// Usage:
...
/**
 * Assert HEAD is a clean commit pushed to origin and return its SHA. The
 * release tag is created at this commit, so it must exist on GitHub and match
 * what gets built.
 */
