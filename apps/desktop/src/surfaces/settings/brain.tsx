...
export function BrainSettings(): ReactNode {
  ...
  if (!brain) {
    return (
      <SettingsSection id="brain">
        <p className="px-4 py-3.5 text-sm text-muted-foreground">No active brain.</p>
      </SettingsSection>
    )
  }
  ...
  return (
    <SettingsSection id="brain">
      ...
      <SettingsField legend="Color">
        <Popover open={colorOpen} onOpenChange={setColorOpen}>
          <PopoverTrigger asChild>
            <Button
              variant="outline"
              className="mt-2 w-fit min-w-40 justify-between"
